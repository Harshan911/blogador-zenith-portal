...
// Sample blog posts data for development
...
// In production, this would load data from markdown files
// For now, we'll use the sample data
export const getBlogPosts = (): BlogPost[] => {
  // Here we would load markdown files from the content/blog folder
  // For now, return the sample data
  return sampleBlogPosts;
};

export const getBlogPostBySlug = (slug: string): BlogPost | undefined => {
  // Here we would load a specific markdown file based on the slug
  // For now, find the post in the sample data
